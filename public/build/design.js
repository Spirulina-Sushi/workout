...
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__(/*! ../css/design.css */ "./assets/css/design.css");
...
function exerciseOutput() {
  ...
  for (i = 0; i < foo.children.length; i++) {
    alert(foo.children[i].id.replace("_", " "));
  }
}
