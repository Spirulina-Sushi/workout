...
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__(/*! ../css/go.css */ "./assets/css/go.css");
...
function updateScreenRoundsRest() {
  ...
  document.getElementById("nextExercise").innerHTML = exerciseArray[set + 1]; // document.getElementById(exerciseArray[set] + 0).classList.add("alert alert-primary");
