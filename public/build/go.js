...
function updateScreenRoundsRest() {
  ...
  document.getElementById("time").innerHTML = numberDisplay(currentSeconds); // document.getElementById(exerciseArray[set] + 0).classList.add("alert alert-primary");
